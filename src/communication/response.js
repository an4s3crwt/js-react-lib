...
export class ResponseMessage {
  constructor(display, context, logText = undefined) {
    ...
    this.display = display instanceof LocalizableContent 
      ? display 
      : new LocalizableContent(display.key, display.value, display.keyNamespace, display.dynamicValueDictionary);
